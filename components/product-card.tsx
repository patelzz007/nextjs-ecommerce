        ...
        <div className="relative aspect-[3/4] mb-4 overflow-hidden rounded-sm bg-slate-100">
          ...
          <div className="absolute top-4 left-4 flex flex-col gap-2">
            ...
            {product.stock > 0 && product.stock < 20 && (
              <span className="inline-block px-3 py-1 text-xs font-medium bg-amber-500 text-white">
                Only {product.stock} left
              </span>
            )}
            {product.stock === 0 && (
              <span className="inline-block px-3 py-1 text-xs font-medium bg-slate-500 text-white">Out of Stock</span>
            )}
          </div>
